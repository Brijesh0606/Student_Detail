 ...
 */
public class Exam extends Fragment implements SelectListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recycleviewexam);
        ...
        for (Student student : students) {
            ...
            if (35.0d <= score) {
                exam[j] = new Student(student.getId(), student.getName(), student.getScores());
                j++;
            }
    ...
    public void onItemClick(int position) {
        ...
        i.putExtra("id",exam[position].getId());
        i.putExtra("name",exam[position].getName());

        scores[] scores = exam[position].getScores();
