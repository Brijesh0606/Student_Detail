 ...
 */
public class quiz extends Fragment implements SelectListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recycleviewquiz);
        ...
        quiz = new Student[studentname.size()];
        int j=0;
        for (Student student : students) {
            scores[] list = student.getScores();
            double score = list[1].getScore();
            ...
            if (35.0d <= score) {
                quiz[j] = new Student(student.getId(), student.getName(), student.getScores());
                j++;
            }
    ...
    public void onItemClick(int position) {
        ...
        i.putExtra("id",quiz[position].getId());
        i.putExtra("name",quiz[position].getName());

        scores[] scores = quiz[position].getScores();
